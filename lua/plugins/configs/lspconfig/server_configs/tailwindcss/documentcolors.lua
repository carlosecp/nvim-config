...
function M.buf_attach(bufnr, options)
  ...
  local trigger_update_highlight, timer = require("plugins.configs.lspconfig.server_configs.tailwindcss.defer").debounce_trailing(M.update_highlight, options.debounce or 200, false)
