...
function M.buf_attach(bufnr, options)
  ...
  local trigger_update_highlight, timer = require("carlosecp.lsp.settings.tailwindcss.defer").debounce_trailing(M.update_highlight, options.debounce or 200, false)
