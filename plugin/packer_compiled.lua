...
_G.packer_plugins = {
  ["FTerm.nvim"] = {
    commands = { 'lua require"FTerm".toggle()' },
  ...
  ["lspsaga.nvim"] = {
    config = { "\27LJ\2\2(\0\0\2\0\2\0\0046\0\0\0'\1\1\0B\0\2\1K\0\1\0\r_lspsaga\frequire\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\2(\0\0\2\0\2\0\0046\0\0\0'\1\1\0B\0\2\1K\0\1\0\r_lspsaga\frequire\0", "config", "lspsaga.nvim")
time([[Config for lspsaga.nvim]], false)

-- Command lazy-loads
time([[Defining lazy-load commands]], true)
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file lua require"FTerm".toggle() lua require("packer.load")({'FTerm.nvim'}, { cmd = "lua require"FTerm".toggle()", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
